...
import os
'''
Special thanks to Parwiz Forogh
https://www.youtube.com/watch?v=45sPjuPJ3vs
How to Build Media Player in Python
Steps build MP3 player 
...
# All the frames
song_frame = LabelFrame(root, text='Current Song', bg='indigo', width=400, height=80)
song_frame.place(x=0, y=0)

button_frame = LabelFrame(root, text='Control Buttons', bg='Midnight Blue', width=400, height=120)
button_frame.place(y=80)

listbox_frame = LabelFrame(root, text='Playlist', bg='Royal Blue')
